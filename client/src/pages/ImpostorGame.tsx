...
const HomeButton = () => (
  <Link href="/">
    <button
      className="fixed top-4 left-4 z-40 flex items-center gap-2 px-4 py-2 bg-[#00f2ea]/20 border border-[#00f2ea]/50 rounded-full text-[#00f2ea] hover:bg-[#00f2ea]/30 transition-all"
...
const GameScreen = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-md h-full p-6 animate-fade-in space-y-6 relative z-10">
      <HomeButton />
      <DonationButton onClick={() => setShowAdPopup(true)} />
